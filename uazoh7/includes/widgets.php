...
<figure><a href="<?php the_permalink(); ?>" class="colorbox" title="<?php the_title(); ?>"><?php echo get_the_post_thumbnail($post->ID,'uazoh-image-size-6'); ?></a><figcaption><a href="<?php $thumrb_id = get_post_thumbnail_id($post->ID);$image_urrl = wp_get_attachment_url($thumrb_id); echo $image_urrl; ?>" title="<?php the_title(); ?>" class="colorbox"><i class="fa fa-plus"></i></a></figcaption></figure>
