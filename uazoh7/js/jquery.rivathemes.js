...
//					$wrapper.width(scrol - offsetLeft);
				...
				if (!isReadry)  {
					if ($this.hasClass('uazoh7-section-projects')) {
						fixH = scrol * 0.6;
					}
				}
...
(function( $ ){
	$.fn.rivaSorting = function( options ) {
		var $this = this,
			...
			$filters = $this.find('.uazoh7-sorting-filters'),
			$elems = $this.find('.uazoh7-sorting-item');
		if (showAll) {
