...
<body style="margin:0;padding:0;">
	<div style="width:960px;overflow:hidden;margin:0 auto;padding:0;">
        ...
        if (empty($_GET['page'])||$_GET['page']<1) { 
          ...
          $sql = "SELECT * from `arbiter` limit $offset,$Page_size";
          $result = mysql_query($sql);
          $nums = mysql_num_rows($result); 
           ...
           <div style="width:290px; height:280px; border:1px solid #c9cacb;margin:10px 35px 30px 0px; float:left;">    
                <div style="margin:0px auto;">
                    <a href=<?php echo 'arbiter_info?id='.$row['id'];?>
                    <center><img src=<?php echo $http.'/wordpress/wp-content/themes/uazoh7/img/arbiter/'.$row['id'].'.'.'jpg'?> width="290px" height="216px" /></center>
                	</a>
                </div>
